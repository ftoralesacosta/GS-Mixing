...
// Wed Dec 20 23:33:47 2017 by ROOT version 6.10/08
// from TTree _tree_event/
// found on file: 13e_clusterv2_small.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   UInt_t          ncluster;
   Float_t         cluster_e[32];   //[ncluster]
   Float_t         cluster_pt[32];   //[ncluster]
   Float_t         cluster_eta[32];   //[ncluster]
   Float_t         cluster_phi[32];   //[ncluster]
   Float_t         cluster_lambda_square[32][2];   //[ncluster]
   Float_t         cluster_tof[32];   //[ncluster]
   Int_t           cluster_ncell[32];   //[ncluster]
   UShort_t        cluster_cell_id_max[32];   //[ncluster]
   Float_t         cluster_e_max[32];   //[ncluster]
   Float_t         cluster_e_cross[32];   //[ncluster]
   UChar_t         cluster_nlocal_maxima[32];   //[ncluster]
   UInt_t          cluster_nmc_truth[32];   //[ncluster]
   UShort_t        cluster_mc_truth_index[32][32];   //[ncluster]
   Float_t         cluster_iso_tpc_01[32];   //[ncluster]
   Float_t         cluster_iso_tpc_01_ue[32];   //[ncluster]
   Float_t         cluster_iso_tpc_02[32];   //[ncluster]
   Float_t         cluster_iso_tpc_02_ue[32];   //[ncluster]
   Float_t         cluster_iso_tpc_03[32];   //[ncluster]
   Float_t         cluster_iso_tpc_03_ue[32];   //[ncluster]
   Float_t         cluster_iso_tpc_04[32];   //[ncluster]
   Float_t         cluster_iso_tpc_04_ue[32];   //[ncluster]
   Float_t         cluster_iso_its_01[32];   //[ncluster]
   Float_t         cluster_iso_its_01_ue[32];   //[ncluster]
   Float_t         cluster_iso_its_02[32];   //[ncluster]
   Float_t         cluster_iso_its_02_ue[32];   //[ncluster]
   Float_t         cluster_iso_its_03[32];   //[ncluster]
   Float_t         cluster_iso_its_03_ue[32];   //[ncluster]
   Float_t         cluster_iso_its_04[32];   //[ncluster]
   Float_t         cluster_iso_its_04_ue[32];   //[ncluster]
   Float_t         cluster_frixione_tpc_04_02[32];   //[ncluster]
   Float_t         cluster_frixione_tpc_04_05[32];   //[ncluster]
   Float_t         cluster_frixione_tpc_04_10[32];   //[ncluster]
   Float_t         cluster_frixione_its_04_02[32];   //[ncluster]
   Float_t         cluster_frixione_its_04_05[32];   //[ncluster]
   Float_t         cluster_frixione_its_04_10[32];   //[ncluster]
   Float_t         cluster_iso_01_truth[32];   //[ncluster]
   Float_t         cluster_iso_02_truth[32];   //[ncluster]
   Float_t         cluster_iso_03_truth[32];   //[ncluster]
   Float_t         cluster_iso_04_truth[32];   //[ncluster]
   Float_t         cluster_frixione_04_02_truth[32];   //[ncluster]
   Float_t         cluster_frixione_04_05_truth[32];   //[ncluster]
   Float_t         cluster_frixione_04_10_truth[32];   //[ncluster]
   Float_t         cluster_s_nphoton[32][4];   //[ncluster]
   Float_t         cluster_s_ncharged_hadron[32][4];   //[ncluster]
   Float_t         cell_e[17664];
   Float_t         cell_tof[17664];
   UShort_t        cell_cluster_index[17664];
   UShort_t        cell_mc_truth_index[17664];
   UInt_t          ntrack;
   Float_t         track_e[1708];   //[ntrack]
   Float_t         track_pt[1708];   //[ntrack]
   Float_t         track_eta[1708];   //[ntrack]
   Float_t         track_phi[1708];   //[ntrack]
   Float_t         track_eta_emcal[1708];   //[ntrack]
   Float_t         track_phi_emcal[1708];   //[ntrack]
   Char_t          track_charge[1708];   //[ntrack]
   UChar_t         track_quality[1708];   //[ntrack]
   Float_t         track_tpc_dedx[1708];   //[ntrack]
   Float_t         track_tpc_length_active_zone[1708];   //[ntrack]
   UChar_t         track_tpc_xrow[1708];   //[ntrack]
   UChar_t         track_tpc_ncluster[1708];   //[ntrack]
   UChar_t         track_tpc_ncluster_dedx[1708];   //[ntrack]
   UChar_t         track_tpc_ncluster_findable[1708];   //[ntrack]
   UChar_t         track_its_ncluster[1708];   //[ntrack]
   Float_t         track_its_chi_square[1708];   //[ntrack]
   Float_t         track_dca_xy[1708];   //[ntrack]
   Float_t         track_dca_z[1708];   //[ntrack]
   UShort_t        track_mc_truth_index[1708];   //[ntrack]
   Float_t         track_voronoi_area[1708];   //[ntrack]
   UInt_t          nmc_truth;
   ...
   Float_t         cluster_NN1[32];   //[ncluster]
   Float_t         cluster_NN2[32];   //[ncluster]
   Float_t         cluster_Lambda[32];   //[ncluster]
   Float_t         cluster_isHardPhoton[32];   //[ncluster]
   Float_t         cluster_minMass[32];   //[ncluster]
   Int_t           cluster_pi0tagged[32];   //[ncluster]
   Float_t         cluster_b5x5[32];   //[ncluster]
   Float_t         cluster_b5x5_lin[32];   //[ncluster]
   ...
   virtual void     StableMarriage(vector <vector <Long64_t> > men_data, vector <vector <Long64_t> > women_data);
   virtual Long64_t Least_Liked(vector <Long64_t> &bride_pref, vector <Long64_t> &brides_men);
...
#ifdef Mixing_cxx
Mixing::Mixing(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("13e_clusterv2_small.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("13e_clusterv2_small.root");
      }
